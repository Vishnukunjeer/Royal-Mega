    ...
    <div className="bg-black text-white">
      <div className=" hidden sm:block bg-black text-white relative overflow-hidden ">
        <nav className="bg-black border-b border-[#d4af37] lg:hidden sticky top-0 z-50">
          ...
          {/* DROPDOWN MENU */}
          <div
            className={`absolute left-0 w-full bg-[#111] border-b border-[#d4af37]/50 transition-all duration-300 ease-in-out overflow-hidden ${menuOpen ? "max-h-80 opacity-100" : "max-h-0 opacity-0"
              }`}
          >
