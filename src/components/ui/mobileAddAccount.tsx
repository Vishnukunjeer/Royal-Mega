...
export const Addaccount = () => {
  ...
  return (
    <div>
      ...
      />
      <div className="flex items-center gap-3 bg-primary   text-black px-4 py-3 rounded mt-2">
      ...
      <div className="m-5 flex flex-col gap-2">
        ...
        <div>
          ...
          <div className="flex mt-1">
            ...
            {/* Icon Button */}
            <button
              className="bg-primary   px-4 flex items-center justify-center rounded-r-lg"
            >
      ...
      <div className="flex gap-4 justify-between mt-1">
        ...
        <button className="bg-linear-to-r  px-20 from-primary   to-[#E3BA5D] text-black  py-2 rounded text-sm border border-white">
          Add Account
        </button>
      </div>
      <MobileFooter />
