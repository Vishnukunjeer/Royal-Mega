      ...
      <div className="flex-1 min-w-0  overflow-y-auto bg-black z-30">
          ...
          <>
            ...
            <div className="p-6 pb-24 -mt-5">
              ...
              <div className="flex flex-col gap-3">
                ...
                <button className="bg-linear-to-r from-primary   to-[#E3BA5D] text-black px-10 py-2 rounded text-sm font-medium">
                  Save
                </button>
              </div>
            </div>
        ...
        {activeTab === "Wallet" && (
          ...
          <div className="min-h-200">
            <div className="flex items-center gap-3 bg-primary   text-black px-4 py-3 rounded pb-5 overflow-y-auto">
              <button onClick={() => navigate(-1)}>←</button>
            ...
            <div className="relative">
              ...
              <span className=" text-primary   font-black px-10 text-2xl text-shadow-black"> ₹5,22,850</span>
              <div className="flex justify-between pl-3 pr-3 pt-3">
                ...
                <button className="flex border border-white bg-primary   px-3 py-2 mx-1  m-1 rounded-2xl mr-2"><CirclePlus size={14} className="mt-1.5" />
                  Add Balance
                </button>
              </div>
              <div className="border-2 border-primary   mt-10 mr-15 ml-3  flex rounded-lg">
                <button
                  onClick={() => setActiveBtn("transactions")}
                  className={`w-1/2 py-2 text-sm font-medium transition-all ${activeBtn === "transactions"
                    ? "bg-primary   text-black rounded-xl m-1"
                    : "text-white m-1"
                    }`}
                >
                  Transactions
                ...
                <button
                  ...
                  className={`w-1/2 py-2 text-sm font-medium ${activeBtn === "payments"
                    ? "bg-primary   text-black rounded-xl m-1"
                    : "text-white m-1"
                    }`}
                >
              ...
              <div className="bg-white rounded-2xl mt-4 shadow-sm overflow-hidden mx-3">
                ...
                {transactions.map((tx, index) => (
                  <div
                    key={index}
                    className={`grid grid-cols-3 px-2 py-3 text-sm text-center ${index === 0 ? "bg-green-100" : "bg-white"
        ...
        {activeTab === "Bet History" && (
          <div className="min-h-screen bg-[#0b0b0b] text-white mb-15">
            ...
            {/*   */}
            <div className="flex items-center gap-3 bg-primary   text-black px-4 py-3">
              <button onClick={() => navigate(-1)}>←</button>
            ...
            <div className="p-4 space-y-4">
              ...
              {historyData.map((item, i) => (
                ...
                <div key={i} className="border-r border-primary   bg-white text-black rounded-xl pt-4 pb-4 space-y-2 pr-1 pl-">
                  ...
                  <div className="grid grid-cols-2">
                    ...
                    <div className="flex justify-between text-sm">
                      <span>Status</span>
                      <span className={`font-semibold ${item.status === "Loss"
                        ? "text-red-500"
                        : item.status === "Won"
                          ? "text-green-600"
                          : "text-yellow-500"
        ...
        {activeTab === "Account" && (
          <div className="bg-black">
            <div className="flex items-center gap-3 mt-2 bg-primary   text-black px-4 py-3 rounded pb-5">
              <button onClick={() => navigate(-1)}>←</button>
              <h1 className="font-semibold">Bank Details</h1>
            </div>
            <button className="text-black border bg-primary   flex flex-row font-bold ml-5 px-28 py-4 rounded mt-5" onClick={() => navigate("/AddAccount")}>
              <Landmark />
              Add Account</button>
          </div>
        )}
        ...
        {activeTab === "Settings" && (
          <>
            ...
            <div className="flex gap-4 justify-between mt-40">
              <button className="bg-black text-white px-6 py-2 rounded border border-primary   text-sm" onClick={() => navigate("/change-password")}>
                Change password
              </button>

              <button className="bg-linear-to-r  px-20 from-primary   to-[#E3BA5D] text-black  py-2 rounded text-sm">
                Save
              </button>
            </div>
